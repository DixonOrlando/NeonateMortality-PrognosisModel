...
clear all
sknor 1000000 1111 -2.77 0.98 2 9 ///modified parameter value to use the available option for the function.
hist skewnormal
...
clear all
sknor 1000000 1111 -2.77 0.98 2 9
gen LP = skewnormal
