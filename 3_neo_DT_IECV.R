...
###MICE IMPUTATION FUNCTION FOR THE CROSS-VALIDATION###
...
mice_imp <- function(train, test, id) {
  ...
  imp <- mice(train %>% 
                select(AdDxMENG, AdDxSEPS, AdDxASPH, AdDxMEC, AdDxRDS,  Q12SEX, Q37RESPI2, Q38CYANO2, Q38MATER2, Q39PROLO2, Q40JAUND2, Q40OFFEN2, Q42LETHA2, Q42UNBRE2, Q43CONVU2, Q43HYPOT2, Q48WEIGH, Q49SEVER2, Q50UMBLI2, Q50HEART, Q51RESPI, Q51BULGI2, Q52SP02P, Q53TEMPE, preterm, cluster_code, Died, FullOxygen) %>%
...
###MICE IMPUTATION FUNCTION FOR THE TRAINING DATA###
...
for (i in unique(final_neo$cluster_code)) {
  ...
  tree_test_rec = recipe(Died ~ AdDxMENG + AdDxSEPS + AdDxASPH + AdDxMEC + AdDxRDS + Q12SEX + Q37RESPI2 + Q38CYANO2 + Q38MATER2 + Q39PROLO2 + Q40JAUND2 + Q40OFFEN2 + Q42LETHA2 + Q42UNBRE2 + Q43CONVU2 + Q43HYPOT2 + Q48WEIGH + Q49SEVER2 + Q50UMBLI2 + Q50HEART + Q51RESPI + Q51BULGI2 + Q52SP02P + Q53TEMPE + preterm + FullOxygen, 
                         data = child_test1) %>%
